...
%$^{2}$ \quad School of Physics, Georgia Institute of Technology\\
%$^{3}$ \quad School of Chemistry and Biochemistry, Georgia Institute of Technology\\
...
$^{2}$ School of Physics, Georgia Institute of Technology\\
...
To examine the ability of dopant metals to improve photocatalytic nitrogen reduction, a potential was applied equivalent to the potential of excited electrons at the band edge. The highest barrier of the rate limiting step plotted vs the NH$_2$* binding energy may be seen in Figure \ref{fig:NH2_limiting_bar}. 

The lack of improvement in the rate of reaction with metal addition also agrees with the previous experimental findings by Hirakawa et. al.\cite{Hirakawa_2017} on TiO$_2$ which show no improvements in reaction rates when metals are bound to the surface. Despite the limitations of surface metal doping for TiO$_2$, based on the ability of dopant sites to modify the thermodynamics on the surface seen in this work and prior work \cite{Garc_a_Mota_2011,Xu_2015,Yao_2017,} we assert that the strategy of generating dopant sites is a fruitful path forward for improving the reactivity of oxides. 
