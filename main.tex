...
\begin{figure}
    ...
    \caption{An example of the screened 4+ slabs. The substituent metal has replaced a 5 fold Ti atom (seen in green) and a bridging oxygen vacancy has been formed to allow the metal to enter the 2+ oxidation state.}
    \label{fig:2+ex_slab}
\end{figure}
