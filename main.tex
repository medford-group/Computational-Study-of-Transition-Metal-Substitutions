...
\begin{figure}
    ...
    \caption{Formation energy of surface sites with respect to their bulk metalic form vs the substituted metal's \textit{d}-band center as reported by Ruban et. al \cite{Ruban_1997}. The formation energy of metals being doped into bulk rutile is plotted for reference.}
    \label{fig:d_band}
\end{figure}
