...
\begin{figure}
    ...
    \caption{An example of the screened 4+ slabs. The substituent metal has replaced a five-fold Ti atom (seen in blue), and a bridging oxygen vacancy has been formed to allow the metal to enter the 4+ oxidation state.}
    \label{fig:2+ex_slab}
\end{figure}
