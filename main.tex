...
\begin{figure}
    ...
    \caption{(top) The limiting potential vs the NH$_2$ Binding Energy. (bottom)The highest barrier observed vs the NH$_2$ Binding Energy. Any surface for which a full path was not available has been excluded.}
\end{figure}
